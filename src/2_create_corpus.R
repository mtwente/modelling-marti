...
meta_marti <- annotate(data = corpus_df,
                      ...
                      column_description = c("ID des Artikels",
                                             ...
                                             "Angabe, ob Hans Marti zum Veröffentlichungszeitpunkt ein politisches Mandat innehatte (gemeint sind seine Mitgliedschaft im Zürcher Gemeinderat und sein Amt als Delegierter für Stadtplanung)"),
